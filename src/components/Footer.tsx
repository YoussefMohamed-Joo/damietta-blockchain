...
const cols: { title: string; key: string; items: [string, string][] }[] = [
    ...
    { title: t('footer.explore'), key: 'explore', items: [[t('footer.tools'), '/tools'], [t('footer.research'), '/research'], [t('footer.news'), '/news'], [t('footer.guide'), '/guide']] },
  ...
  return (
    <footer style={{ padding: '3.5rem 2rem 0', marginTop: 'auto', background: '#0F172A', borderTop: '1px solid rgba(255,255,255,.06)', position: 'relative', zIndex: 1, overflow: 'hidden' }}>
      <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', pointerEvents: 'none', zIndex: 0, opacity: .3 }}>
